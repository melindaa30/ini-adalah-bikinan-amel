    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        <form method="get" action="index.php?route=/&lang=en" class="disableAjax">
          <input type="hidden" name="route" value="/export"><input type="hidden" name="db" value="db_melinda"><input type="hidden" name="lang" value="en"><input type="hidden" name="token" value="5225282c5e64794f5f5d6432622d4d28">
...
<form method="post" id="login_form" action="index.php?route=/" name="login_form" class="disableAjax hide js-show">
    <input type="hidden" name="route" value="/export"><input type="hidden" name="db" value="db_melinda"><input type="hidden" name="lang" value="en"><input type="hidden" name="token" value="5225282c5e64794f5f5d6432622d4d28">
  <input type="hidden" name="set_session" value="a52f8a6df5cd72d54a942f730133523c">
