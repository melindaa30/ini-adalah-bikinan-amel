    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        <form method="get" action="index.php?route=/&lang=en" class="disableAjax">
          <input type="hidden" name="route" value="/export"><input type="hidden" name="db" value="db_melinda"><input type="hidden" name="lang" value="en"><input type="hidden" name="token" value="52285b3e725f5253384f366364682671">
...
<form method="post" id="login_form" action="index.php?route=/" name="login_form" class="disableAjax hide js-show">
    <input type="hidden" name="route" value="/export"><input type="hidden" name="db" value="db_melinda"><input type="hidden" name="lang" value="en"><input type="hidden" name="token" value="52285b3e725f5253384f366364682671">
  <input type="hidden" name="set_session" value="59dc047d4a91eebcf7286cef488bec02">
